...
class Anu{
 ...
 class Student{
     public static void main(String[] args) {
         ...
         ArrayList<Anu> List = new ArrayList<>();
         for(int i=0;i<noofstu;i++)
         {
             String name = sc.nextLine();
             int score = sc.nextInt();
             sc.nextLine();
             List.add(new Anu(name,score));

         }
         System.out.println("Students detail");
         for(Anu a :List)
         {
             System.out.println("name: "+a.name+", Score: "+a.score);
         }
     }
 }